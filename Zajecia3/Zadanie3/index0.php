...
$_SESSION['kodPocztowy'] = $_GET['kodPocztowy'];
$_SESSION['wiek'] = $_GET['wiek'];
$_SESSION['kraj'] = $_GET['kraj'];
...
echo "<div style='margin-top: 50px'><input type='submit' value='Submit' name='info'></div>
</form>
";
?>
